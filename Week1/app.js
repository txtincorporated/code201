...
var question1 = document.getElementById('whereLived');
var question2 = document.getElementById('birthplace');
var question3 = document.getElementById('profession');
var question4 = document.getElementById('interests');
var question5 = document.getElementById('secretNumber');
...
for (i = 0;i < questionIds.length; i++) {
  superQuiz(questionIds[i],questionType[i]);
}

function superQuiz(id, qType) {
